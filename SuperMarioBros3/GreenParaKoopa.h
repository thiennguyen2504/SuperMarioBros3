...
#define HEADSHOT_JUMP_SPEED -0.12f
...
#define GREEN_PARAKOOPA_STATE_HEADSHOT 300
...
protected:
    ...
    virtual int IsCollidable() { return state != GREEN_PARAKOOPA_STATE_DIE && state != GREEN_PARAKOOPA_STATE_HEADSHOT; }
